    ...
    return (
        <main className="presentation--container">
            <div>
                ...
                I am a passionate Computer Science student with a <span className="red">deep love</span> for all things tech. <br/>
                My journey with computers began in childhood, and I have since explored various areas of development. <br/>
                I specialize in both <b>web development</b> (front-end and back-end) and general <b>software development</b>, <br/>with experience in languages such as Java, C, and Python. <br/>
                I enjoy tackling complex problems and continuously expanding my knowledge in the ever-evolving world of technology.
                </p>
            </div>
            <div className="profile--image">
                <img src="/profile_avatar.jpeg" alt="profile image"/>
            </div>
        </main>
    )
}